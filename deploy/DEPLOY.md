...
```
NODE_ENV=production
APP_URL=https://kistie-store-production.up.railway.app
...
## Post-deploy
1. Verify SSL: https://kistie-store-production.up.railway.app
2. Test health: https://kistie-store-production.up.railway.app/api/health
